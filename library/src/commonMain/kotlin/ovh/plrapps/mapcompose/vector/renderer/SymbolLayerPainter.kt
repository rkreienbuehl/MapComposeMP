...
sealed class Symbol(
    ...
    fun render() {
        ...
        val (canvasWidth, canvasHeight) = when (this) {
            is SpriteWithText -> {
                val totalWidth = max(spriteSize.width, textSize.width) / density
...
//            println("spriteInfo == null for spriteId $spriteId")
        ...
        return LabelPlacement(
            ...
            obb = OBB(
                ...
                ovh.plrapps.mapcompose.vector.utils.obb.Size(size.width.toFloat(), size.height.toFloat()),
                placement.angle
            ),
    ...
    private fun produceSpriteWithText(
        ...
        val spriteLabelPlacement = LabelPlacement(
            ...
            obb = OBB(
                spritePosition,
                ovh.plrapps.mapcompose.vector.utils.obb.Size(spriteSize.width.toFloat(), spriteSize.height.toFloat()),
                0f
            ),
            priority = layout.symbolZOrder?.process(featureProperties, actualZoom)?.toInt() ?: 0,
            allowOverlap = layout.iconAllowOverlap?.process(featureProperties, actualZoom) ?: false,
        ...
        val textLabelPlacement = LabelPlacement(
            ...
            obb = OBB(
                textPosition,
                ovh.plrapps.mapcompose.vector.utils.obb.Size(textSize.width.toFloat(), textSize.height.toFloat()),
                0f
            ),
            priority = layout.symbolZOrder?.process(featureProperties, actualZoom)?.toInt() ?: 0,
    ...
    private fun produceLineText(
        ...
        lineStrings.forEachIndexed lineStrings@{ indexLine, line ->
            ...
            val placements = LineLabelPlacement.Companion.calculatePlacements(line, textWidth, symbolSpacing)
            ...
            placements.forEachIndexed { index, (pos, angle) ->
                ...
                try {
                    ...
                    return LabelPlacement(
                        ...
                        obb = OBB(
                            ObbPoint(x, y),
                            ovh.plrapps.mapcompose.vector.utils.obb.Size(textWidth, textHeight),
                            displayAngle
                        ),
                        priority = layout.symbolZOrder?.process(featureProperties, actualZoom)?.toInt() ?: 0,
                        allowOverlap = layout.textAllowOverlap?.process(featureProperties, actualZoom) ?: false,
        ...
        try {
            ...
            return LabelPlacement(
                ...
                obb = OBB(
                    ...
                    size = ovh.plrapps.mapcompose.vector.utils.obb.Size(textWidth, textHeight),
